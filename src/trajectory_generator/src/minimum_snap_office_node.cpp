...
void generateGlobaltrajectory(polynomial_trajectories::PolynomialTrajectory &trajectory)
{
    ...
    Eigen::Vector3d goal_init(0.0, 0.0, 2);
    Eigen::Vector3d goal_0(3.5, 0.0, 1.3);
    Eigen::Vector3d goal_1(6.5, -3.0, 0.8);
    Eigen::Vector3d goal_2(3.170861, -6.22201, 0.);
    Eigen::Vector3d goal_3(0.60463, -3, 1.4);
